...
import type { IDataCompressor, IDataCompressorInterface } from "./interface";
...
export class IDataCompressor__factory {
  ...
  static createInterface(): IDataCompressorInterface {
    return new Interface(_abi) as IDataCompressorInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null,
  ): IDataCompressor {
    return new Contract(address, _abi, runner) as unknown as IDataCompressor;
  }
}
